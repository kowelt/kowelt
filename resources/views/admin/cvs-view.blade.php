...
@section('content')
    <div id="main-content" class="w-full flex-1">
        ...
        <div class="p-6 md:p-10 lg:p-16 flex justify-between items-center">
            <div>
                <p class="text-4xl font-semibold">View (CV: {{ $curriculum_vitae->user->firstname . ' ' . $curriculum_vitae->user->lastname }})</p>
            </div>
        </div>
                            ...
                            <div class="accordion-body py-4 px-5">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6">
                                        <label for="avatar" class="block text-sm font-medium text-gray-700">Photo Upload</label>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" id="firstname" disabled value="{{ $curriculum_vitae->user->firstname }}" class="mt-1 bg-gray-50">
                                    </div>

                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="lastname" class="block text-sm font-medium text-gray-700">{{ __('account.lastname') }}<span class="text-red-500">*</span></label>
                                        <input type="text" id="lastname" disabled value="{{ $curriculum_vitae->user->lastname }}" class="mt-1 bg-gray-50">
                                    </div>

                                    <div class="col-span-6">
                                        <label for="email" class="block text-sm font-medium text-gray-700">{{ __('account.e_mail') }}<span class="text-red-500">*</span></label>
                                        <input type="email" id="email" disabled value="{{ $curriculum_vitae->user->email }}" class="mt-1 bg-gray-50">
                                    </div>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="date" id="date_of_birth" value="{{ $curriculum_vitae->user->date_of_birth ?? old('date_of_birth') }}" disabled class="mt-1 bg-gray-50">
                                    </div>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <select id="gender" disabled class="mt-1 bg-gray-50">
                                            <option value="1" {{ $curriculum_vitae->user->gender == '1' ? 'selected' : '' }} disabled>{{ __('account.homme') }}</option>
                                            <option value="2" {{ $curriculum_vitae->user->gender == '2' ? 'selected' : '' }} disabled>{{ __('account.femme') }}</option>
                                            <option value="3" {{ $curriculum_vitae->user->gender == '3' ? 'selected' : '' }} disabled>{{ __('account.divers') }}</option>
                                        </select>
                                    </div>

                                    <div class="col-span-6">
                                        <label for="tel" class="block text-sm font-medium text-gray-700">{{ __('account.tel') }}<span class="text-red-500">*</span></label>
                                        <input type="tel" id="tel" name="tel" @if($section_3 == 'verify') disabled @endif value="{{ $curriculum_vitae->tel ?? old('tel') }}" required class="mt-1">
                                    </div>

                                    <div class="col-span-6">
                                        <label for="street" class="block text-sm font-medium text-gray-700">{{ __('account.adresse') }}<span class="text-red-500">*</span></label>
                                        <input type="text" id="street" name="street_and_number" @if($section_3 == 'verify') disabled @endif value="{{ $curriculum_vitae->street_and_number ?? old('street_and_number') }}" required class="mt-1">
                                    </div>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="number" id="postal_code" name="postal_code" @if($section_3 == 'verify') disabled @endif value="{{ $curriculum_vitae->postal_code ?? old('postal_code') }}" required class="mt-1">
                                    </div>

                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="city" class="block text-sm font-medium text-gray-700">{{ __('account.Ville') }}<span class="text-red-500">*</span></label>
                                        <input type="tel" id="city" name="city" @if($section_3 == 'verify') disabled @endif value="{{ $curriculum_vitae->city ?? old('city') }}" required class="mt-1">
                                    </div>


                                    <div class="col-span-6">
                                        <label for="country" class="block text-sm font-medium text-gray-700">{{ __('Country') }}<span class="text-red-500">*</span></label>
                                        <select id="country" name="country" @if($section_3 == 'verify') disabled @endif required class="mt-1">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input type="text" id="place_of_birth" name="place_of_birth" @if($section_3 == 'verify') disabled @endif value="{{ $curriculum_vitae->place_of_birth ?? old('place_of_birth') }}" required class="mt-1">
                                    </div>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <select id="nationality" name="nationality" @if($section_3 == 'verify') disabled @endif required class="mt-1">
                                            <option value="" selected>{{ __('account.Veuillez_sélectionner') }}...</option>
                                            @foreach(config('countries_list_' . app()->getLocale()) as $code => $country)
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <select id="martial_status" name="martial_status" @if($section_3 == 'verify') disabled @endif class="mt-1">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <select onchange="setToggleDriverLicenceInputCategory(this.value)" id="driving_licence" name="driving_licence" @if($section_3 == 'verify') disabled @endif class="mt-1">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input type="text" id="linkedin" name="linkedin" @if($section_3 == 'verify') disabled @endif value="{{ $curriculum_vitae->linkedin ?? old('linkedin') }}" class="mt-1">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    @isset($curriculum_vitae->educations)
                                        @foreach($curriculum_vitae->educations as $education)
                                            <div id="{{ 'education_item_' . $education->id }}" class="flex justify-between items-center bg-gray-200 p-4 mb-4">
                                                <div>
                                                    <p><b>Degree</b>: {{ $education->education_degree }}</p>
                                                    <p><b>From</b>: {{ $education->education_start_date_string }} <b>To</b>: {{ $education->education_end_date_string }}</p>
                                                    <p><b>Institut</b>: {{ $education->education_institut }}</p>
                                                    <p><b>City</b>: {{ $education->education_city }}</p>
                                                    <p><b>Description</b>: {{ $education->education_description }}</p>
                                                </div>
                                    ...
                                    @isset($curriculum_vitae->works)
                                        @foreach($curriculum_vitae->works as $work)
                                            <div id="{{ 'work_item_' . $work->id }}" class="flex justify-between items-center bg-gray-200 p-4 mb-4">
                                                <div>
                                                    <p><b>Title</b>: {{ $work->work_title }}</p>
                                                    <p><b>From</b>: {{ $work->work_start_date_string }} <b>To</b>: {{ $work->work_end_date_string }}</p>
                                                    <p><b>Institut</b>: {{ $work->work_employer }}</p>
                                                    <p><b>City</b>: {{ $work->work_city }}</p>
                                                    <p><b>Description</b>: {{ $work->work_description }}</p>
                                                </div>
                                                <div class="@if($section_3 == 'verify') hidden @endif">
                                                    <div class="w-fit flex gap-x-4 items-center">
                                ...
                                <div class="@if($section_3 == 'verify') hidden @endif">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            {{--                            <input type="text" id="language_name" class="mt-1">--}}
      ...
      " type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree9" aria-expanded="{{ $section_3 == 'verify' ? 'true' : 'false' }}"
                            ...
                            <div class="accordion-body py-4 px-5">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6">
                                        ...
                                        <textarea rows="5" id="other_description" name="other_description" class="mt-1" @if($section_3 == 'verify') disabled @endif>{{ $curriculum_vitae->other_description ?? old('other_description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex justify-end gap-5 mt-5">
                    <a class="px-10 py-3 text-white border border-black text-black hover:bg-black hover:text-white rounded" href="{{ route('admin.cv', app()->getLocale()) }}">Back</a>
                </div>
            </div>

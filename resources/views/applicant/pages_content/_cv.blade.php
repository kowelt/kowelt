<br>
<br>
<div class="col-span-5 md:col-span-4 bg-white p-5 shadow max-w-5xl mx-auto">
    @if ($errors->any())
    ...
    @endif
    @if($section_3 == 'verify')
        <div class="text-xl pb-8 py-4 italic">{{ __('account.Thank_you_very_much') }}</div>
    @endif
    <form @if(isset($curriculum_vitae)) action="{{ route('applicant.update.cv', [app()->getLocale(), $curriculum_vitae->id]) }}" @else action="{{ route('applicant.store.cv', app()->getLocale()) }}" @endif method="POST">
        ...
        <input type="hidden" id="section_3" value="{{ $section_3 }}">
        ...
        py-6
        px-5
        text-base text-gray-800 text-left text-xl @if($section_3 == 'verify') text-blue-600 @endif
        bg-white
        border-0
        rounded-none
        transition
      ...
      " type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne5" aria-expanded="true"
                    ...
                    <div class="accordion-body py-4 px-5">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6">
                                ...
                                <input type="file" id="avatar" name="avatar[]" class="mt-1 p-3 @if(isset($curriculum_vitae->picture->path) || $section_3 == 'verify') hidden @endif">
                                <div class="mx-auto w-fit text-center @if(!isset($curriculum_vitae->picture->path)) hidden @endif" id="image_view_div">
                                    <img class="mb-1 max-h-64" id="image_view" src="{{ isset($curriculum_vitae->picture->path) ? asset($curriculum_vitae->picture->path) : '' }}" alt="photo">
                                    @if(isset($curriculum_vitae->picture->id) && $section_3 !== 'verify')
                                        <a onclick="deleteImage({{ $curriculum_vitae->picture->id }})" class="text-red-500 cursor-pointer hover:underline">
                                            <small>{{ __('account.Change_Picture') }}</small>
                                        </a>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-span-6">
                                ...
                                <input type="tel" id="tel" name="tel" @if($section_3 == 'verify') disabled @endif value="{{ $curriculum_vitae->tel ?? old('tel') }}" required class="mt-1 @error('tel') border-red-600 focus:border-red-500 focus:ring-red-500 @enderror">
                            </div>

                            <div class="col-span-6">
                                <label for="street" class="block text-sm font-medium text-gray-700">{{ __('account.adresse') }}<span class="text-red-500">*</span></label>
                                <input type="text" id="street" name="street_and_number" @if($section_3 == 'verify') disabled @endif value="{{ $curriculum_vitae->street_and_number ?? old('street_and_number') }}" required class="mt-1 @error('street_and_number') border-red-600 focus:border-red-500 focus:ring-red-500 @enderror">
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="number" id="postal_code" name="postal_code" @if($section_3 == 'verify') disabled @endif value="{{ $curriculum_vitae->postal_code ?? old('postal_code') }}" required class="mt-1 @error('postal_code') border-red-600 focus:border-red-500 focus:ring-red-500 @enderror">
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                <label for="city" class="block text-sm font-medium text-gray-700">{{ __('account.Ville') }}<span class="text-red-500">*</span></label>
                                <input type="tel" id="city" name="city" @if($section_3 == 'verify') disabled @endif value="{{ $curriculum_vitae->city ?? old('city') }}" required class="mt-1 @error('city') border-red-600 focus:border-red-500 focus:ring-red-500 @enderror">
                            </div>

                            <div class="col-span-6">
                                <label for="country" class="block text-sm font-medium text-gray-700">{{ __('Country') }}<span class="text-red-500">*</span></label>
                                <select id="country" name="country" @if($section_3 == 'verify') disabled @endif required class="mt-1 @error('country') border-red-600 focus:border-red-500 focus:ring-red-500 @enderror">
                            ...
                            <div class="col-span-6">
                                ...
                                <input type="text" id="place_of_birth" name="place_of_birth" @if($section_3 == 'verify') disabled @endif value="{{ $curriculum_vitae->place_of_birth ?? old('place_of_birth') }}" required class="mt-1 @error('place_of_birth') border-red-600 focus:border-red-500 focus:ring-red-500 @enderror">
                            </div>
                            <div class="col-span-6">
                                ...
                                <select id="nationality" name="nationality" @if($section_3 == 'verify') disabled @endif required class="mt-1 @error('nationality') border-red-600 focus:border-red-500 focus:ring-red-500 @enderror">
                                    <option value="" selected>{{ __('account.Veuillez_sélectionner') }}...</option>
                                    @foreach(config('countries_list_' . app()->getLocale()) as $code => $country)
                            ...
                            <div class="col-span-6">
                                ...
                                <select id="martial_status" name="martial_status" @if($section_3 == 'verify') disabled @endif class="mt-1 @error('martial_status') border-red-600 focus:border-red-500 focus:ring-red-500 @enderror">
                            ...
                            <div class="col-span-6">
                                ...
                                <select onchange="setToggleDriverLicenceInputCategory(this.value)" id="driving_licence" name="driving_licence" @if($section_3 == 'verify') disabled @endif class="mt-1 @error('driving_licence') border-red-600 focus:border-red-500 focus:ring-red-500 @enderror">
                            ...
                            <div id="driving_licence_category_div" class="col-span-6 @if(!isset($curriculum_vitae->driving_licence)) hidden @endif @if(isset($curriculum_vitae->driving_licence) && $curriculum_vitae->driving_licence != '1') hidden @endif">
                                ...
                                <input type="text" id="driving_licence_category" @if($section_3 == 'verify') disabled @endif @if(isset($curriculum_vitae->driving_licence) && $curriculum_vitae->driving_licence == '1') name="driving_licence_category" required @endif placeholder="{{ __('account.vide_si_absent') }}" value="{{ $curriculum_vitae->driving_licence_category ?? old('driving_licence_category') }}" class="mt-1 @error('driving_licence_category') border-red-600 focus:border-red-500 focus:ring-red-500 @enderror">
                            </div>
                            <div class="col-span-6">
                                <label for="linkedin" class="block text-sm font-medium text-gray-700">{{ __('account.Linkedin') }}</label>
                                <input type="text" id="linkedin" name="linkedin" @if($section_3 == 'verify') disabled @endif value="{{ $curriculum_vitae->linkedin ?? old('linkedin') }}" class="mt-1 @error('linkedin') border-red-600 focus:border-red-500 focus:ring-red-500 @enderror">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        transition
        focus:outline-none
      " type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo5" aria-expanded="{{ $section_3 == 'verify' ? 'true' : 'false' }}"
                ...
                <div id="collapseTwo5" class="accordion-collapse collapse @if($section_3 == 'verify') show @endif" aria-labelledby="headingTwo5">
                    <div class="accordion-body py-4 px-5">
                            ...
                            @isset($curriculum_vitae->educations)
                                @foreach($curriculum_vitae->educations as $education)
                                    <div id="{{ 'education_item_' . $education->id }}" class="flex justify-between items-center bg-gray-200 p-4 mb-4">
                                        ...
                                        <div class="@if($section_3 == 'verify') hidden @endif">
        ...
        transition
        focus:outline-none
      " type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree5" aria-expanded="{{ $section_3 == 'verify' ? 'true' : 'false' }}"
                ...
                <div id="collapseThree5" class="accordion-collapse collapse @if($section_3 == 'verify') show @endif" aria-labelledby="headingThree5">
                    <div class="accordion-body py-4 px-5">
        ...
        transition
        focus:outline-none
      " type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree6" aria-expanded="{{ $section_3 == 'verify' ? 'true' : 'false' }}"
                ...
                <div id="collapseThree6" class="accordion-collapse collapse @if($section_3 == 'verify') show @endif" aria-labelledby="headingThree6">
                    <div class="accordion-body py-4 px-5">
        ...
        transition
        focus:outline-none
      " type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree7" aria-expanded="{{ $section_3 == 'verify' ? 'true' : 'false' }}"
                ...
                <div id="collapseThree7" class="accordion-collapse collapse @if($section_3 == 'verify') show @endif" aria-labelledby="headingThree7">
                    <div class="accordion-body py-4 px-5">
        ...
        transition
        focus:outline-none
      " type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree8" aria-expanded="{{ $section_3 == 'verify' ? 'true' : 'false' }}"
                ...
                <div id="collapseThree8" class="accordion-collapse collapse @if($section_3 == 'verify') show @endif" aria-labelledby="headingThree8">
                    <div class="accordion-body py-4 px-5">
        ...
        transition
        focus:outline-none
      " type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree9" aria-expanded="{{ $section_3 == 'verify' ? 'true' : 'false' }}"
                ...
                <div id="collapseThree9" class="accordion-collapse collapse @if($section_3 == 'verify') show @endif" aria-labelledby="headingThree9">
                    <div class="accordion-body py-4 px-5">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                <label for="other_description" class="block text-sm font-medium text-gray-700">{{ __('account.Description') }}</label>
                                <textarea rows="5" id="other_description" name="other_description" class="mt-1 @error('other_description') border-red-600 focus:border-red-500 focus:ring-red-500 @enderror"
                                          @if($section_3 == 'verify') disabled @endif>{{ $curriculum_vitae->other_description ?? old('other_description') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        @if($section_3 == 'verify')
            <form action="{{ route('applicant.send.final.cv', app()->getLocale()) }}" method="POST">
                @csrf
                <div class="px-6 py-3 mb-3">
                    <div class="form-check">
                        <input class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="checkbox"
                               required name="confirm_correctness" value="1" id="flexCheckDefault">
                        <label class="form-check-label inline-block text-gray-800" for="flexCheckDefault">
                            {{ __('account.I_confirm') }}
                        </label>
                    </div>
                </div>
                <div class="px-4 py-3 text-left sm:px-6 flex items-center gap-x-4">
                    <a href="{{ route('applicant.dashboard', [app()->getLocale(), 'cv', 'cv-form']) }}" class="inline-flex justify-center rounded-md bg-white text-gray-600 border border-gray-400 py-3 px-6 text-sm font-medium text-white hover:shadow-blue-500/60 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform transition hover:scale-[1.02] duration-300 ease-in-out"
                    >{{ __('account.Back') }}</a>

                    <button type="submit" class="inline-flex justify-center rounded-md gradient-primary py-3 px-6 text-sm font-medium text-white hover:shadow-blue-500/60 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform transition hover:scale-[1.02] duration-300 ease-in-out"
                    >{{ __('account.Submit_Request') }}</button>
                </div>
            </form>
        @endif
</div>

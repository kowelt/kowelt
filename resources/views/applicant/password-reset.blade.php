    ...
    <div class="bg-white text-gray-800 py-4">
        ...
        <div class="md:grid md:grid-cols-2 items-center gap-4 px-5 py-14 max-w-6xl mx-auto">
            ...
            <div class="w-full md:pl-4 pt-10 md:pt-0 pl-10 md:pl-0">
                <div class="text-xl">
                    {{ __('account.Please_enter_your_new_password') }}
                </div>
                <br>
                <form action="{{ route('applicant.password.reset.store', [app()->getLocale(), $reset_token]) }}" method="POST">
                    @csrf
                    <div class="grid grid-cols-6 gap-5">
                        <div class="col-span-5">
                            <label for="password" class="block text-sm font-medium text-gray-700">{{ __('account.new_password') }}</label>
                        ...
                        <div class="col-span-5">
                            <label for="password_confirmation" class="block text-sm font-medium text-gray-700">{{ __('account.confirm_new_password') }}</label>
                            <div class="flex items-center">
                    ...
                    <div class="text-start pt-6">
                        ...
                        >{{ __('account.Password_reset') }}</button>

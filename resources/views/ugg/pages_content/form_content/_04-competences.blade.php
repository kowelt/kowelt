<div id="skill_items_parent">
    @if(isset($ugg_form->skills[0]))
        @foreach($ugg_form->skills->sortBy(['position', 'asc']) as $item)
            <div>
                <div class="flex justify-between items-center bg-gray-200 p-4 mb-4 cursor-move skill-item-view handle">
                    <div class="handle">
                        <p class="handle">{{ $item->skill_name }}</p>
                        <small class="handle">{{ \App\Services\LevelService::getSkillLevel($item->skill_level) }}</small>
                    </div>
                    @if($section_2 !== 'verify')
                ...
                <div id="skill_item_form_1" class="skill-item-form-hide"></div>
    ...
    <div class="mt-6">
        ...
        >
            ...
            <span class="hover:underline">
                {{ __("ugg.Ajouter une nouvelle compétence") }}
            </span>
        </a>
    </div>
@endif
